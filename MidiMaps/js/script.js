...
hotelSearchMap.addListener('click', function(event) {
  ...
  // hotelSearchMap = new google.maps.Map(document.getElementById('hotelSearchMap'), {
      ...
      // var fenway = {lat: 42.345573, lng: -71.098326};
        // pano = new google.maps.Map(document.getElementById('pano'), {
...
function onPlaceChanged() {
        ...
        // var hotelSearchMap = hotelSearchMap;
        // var map = map;
        // var pano = pano;
...
function setAutocompleteCountry() {
        ...
        if (country == 'all') {
          ...
          hotelSearchMap.setCenter({lat: 15, lng: 0});
          hotelSearchMap.setZoom(2);

          map.setCenter({lat: 15, lng: 0});
          map.setZoom(4);

          pano.setCenter({lat: 15, lng: 0});
          pano.setZoom(6);
        } else {
          autocomplete.setComponentRestrictions({'country': country});
          hotelSearchMap.setCenter(countries[country].center);
          hotelSearchMap.setZoom(countries[country].zoom);

          map.setCenter(countries[country].center);
          map.setZoom(countries[country].zoom);

          pano.setCenter(countries[country].center);
          pano.setZoom(countries[country].zoom);
        }
        clearResults();
        clearMarkers();
}
